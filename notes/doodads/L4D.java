    ...
    public void run()
    {
        ...
        for (int i = 0; i < 18; i++)
        {
            ...
            for (int t = 0; t < 4; t++)
            {
                for (int d = 0; d < 16; d++)
                {
                    double dir = d * java.lang.Math.PI * 2 / 16.0;

                    if (t == 1) dir += 0.5 * java.lang.Math.PI * 2 / 16.0;
                    if (t == 3) dir -= 0.5 * java.lang.Math.PI * 2 / 16.0;

//                    if (i == 17)
//                    {
//                        dir = d * java.lang.Math.PI * 2 / 64;
                    //}

                    double cos = java.lang.Math.cos(dir);
                    double sin = java.lang.Math.sin(dir);
            ...
            winLevel: while (true)
            {
                ...
                while (true)
                {
                    if (gameStarted)
                    {
                        ...
                        // Move player:
                        int mouse = m;
                        playerDir = java.lang.Math.atan2(mouse / 240 - 120, mouse % 240 - 120);

                        double shootDir = playerDir + (random.nextInt(100) - random.nextInt(100)) / 100.0 * 0.2;
                        double cos = java.lang.Math.cos(-shootDir);
                        double sin = java.lang.Math.sin(-shootDir);
                        ...
                        for (int i = 0; i < 960; i++)
                        {
                            ...
                            double dd = java.lang.Math.atan2(yt, xt) - playerDir;
                            if (dd < -java.lang.Math.PI) dd += java.lang.Math.PI * 2;
                            if (dd >= java.lang.Math.PI) dd -= java.lang.Math.PI * 2;
...

                        {
                            ...
                            nextMonster: for (int m = 0; m < 256 + 16; m++)
                            {
                                ...
                                if (m == 0)
                                {
                                    d = (((int) (playerDir / (java.lang.Math.PI * 2) * 16 + 4.5 + 16)) & 15);
                                }
                                ...
                                if (monsterData[m * 16 + 10] > 0)
                                {
                                    ...
                                    for (int i = 0; i < amount; i++)
                                    {
                                        ...
                                        double xdd = (java.lang.Math.cos(playerDir + dir) * pow) + random.nextInt(4) - random.nextInt(4);
                                        double ydd = (java.lang.Math.sin(playerDir + dir) * pow) + random.nextInt(4) - random.nextInt(4);
                                ...
                                if (m <= 255)
                                {
                                    ...
                                    dirLoop: for (int i = 0; i < 2; i++)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            double xxd = java.lang.Math.sqrt(xPlayerDist * xPlayerDist);
                                            double yyd = java.lang.Math.sqrt(yPlayerDist * yPlayerDist);
                                            ...
                                            moved = true;
                                            double dir = java.lang.Math.atan2(yPlayerDist, xPlayerDist);
                                            monsterData[m * 16 + 2] = (((int) (dir / (java.lang.Math.PI * 2) * 16 + 4.5 + 16)) & 15);
                                        }
                            ...
                            if (shoot)
                            {
                                ...
                                if (closestHitDist < 120)
                                {
                                    ...
                                    for (int i = 0; i < 10; i++)
                                    {
                                        ...
                                        int xd = (int) (xx - java.lang.Math.cos(playerDir + dir) * pow) + random.nextInt(4) - random.nextInt(4);
                                        int yd = (int) (yy - java.lang.Math.sin(playerDir + dir) * pow) + random.nextInt(4) - random.nextInt(4);
                                        if (xd >= 0 && yd >= 0 && xd < 240 && yd < 240)
                                        {
                                            if (closestHit > 0)
                                            {
