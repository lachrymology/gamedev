    ...
    while(true) {
      ...
      do {
        ...
        if (attractMode) {
          ...
          // update vine
          if (vine) {            
            vineAngle = 0.393f * (float)java.lang.Math.sin(++vineTimer / 46f);
            vx = (float)java.lang.Math.sin(vineAngle);
            vy = (float)java.lang.Math.cos(vineAngle);
            if (!harrySwinging && harryJumping && harryLanded) {
              ...
              float D = B * B - 4 * C;
              if (D >= 0) {
                harryVineRadius = (-B - (float)java.lang.Math.sqrt(D)) / 2;
          ...
          for(i = queue.size() - 1; i >= 0; i--) {
            ...
            if ((timer & 1) == 0 && java.lang.Math.random() < 0.5f) {
              // rattle object
