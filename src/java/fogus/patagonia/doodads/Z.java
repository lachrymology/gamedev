 ...
 *
 * http://java4k.com/index.php?action=games&method=view&gid=337#source
 */
    ...
    while(true) {
      ...
      do {
        ...
        if (attacking > 0) {
          ...
          r = 8 + playerX + (int)(16 * java.lang.Math.cos(angle));
          s = 8 + playerY + (int)(16 * java.lang.Math.sin(angle));
