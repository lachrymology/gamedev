...
import static patagonia.edn.Symbol.newSymbol;
import static patagonia.edn.Tag.newTag;
import static patagonia.edn.parser.Parser.Config.BIG_DECIMAL_TAG;
import static patagonia.edn.parser.Parser.Config.BIG_INTEGER_TAG;
import static patagonia.edn.parser.Parser.Config.DOUBLE_TAG;
import static patagonia.edn.parser.Parser.Config.LONG_TAG;
import static patagonia.edn.util.CharClassify.isDigit;
import static patagonia.edn.util.CharClassify.isWhitespace;
import static patagonia.edn.util.CharClassify.separatesTokens;
...
import patagonia.edn.EdnIOException;
import patagonia.edn.Keyword;
import patagonia.edn.Symbol;
import patagonia.edn.util.CharClassify;
...
class ScannerImpl implements Scanner {
    ...
    /* (non-Javadoc)
     * @see patagonia.edn.parser.ScannerIf#nextToken(patagonia.edn.parser.Parseable)
     */
