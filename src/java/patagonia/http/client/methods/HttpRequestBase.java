...
import patagonia.http.client.utils.CloneUtils;
import patagonia.http.conn.ClientConnectionRequest;
import patagonia.http.conn.ConnectionReleaseTrigger;
import patagonia.http.message.AbstractHttpMessage;
import patagonia.http.message.BasicRequestLine;
import patagonia.http.message.HeaderGroup;
