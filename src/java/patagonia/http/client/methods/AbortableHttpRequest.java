...
package patagonia.http.client.methods;
...
import patagonia.http.conn.ConnectionReleaseTrigger;
...
public interface AbortableHttpRequest {
     ...
     * @see HttpClient#execute(patagonia.http.HttpHost,
     *      patagonia.http.HttpRequest)
     * @see HttpClient#execute(HttpUriRequest,
     *      org.apache.http.protocol.HttpContext)
     * @see HttpClient#execute(patagonia.http.HttpHost,
     *      patagonia.http.HttpRequest, org.apache.http.protocol.HttpContext)
     */
    void abort();
