...
package patagonia.http.client.params;


import patagonia.http.auth.params.AuthPNames;
import patagonia.http.conn.params.ConnConnectionPNames;
import patagonia.http.conn.params.ConnManagerPNames;
import patagonia.http.conn.params.ConnRoutePNames;
import patagonia.http.cookie.params.CookieSpecPNames;
