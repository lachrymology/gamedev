...
public interface CookieAttributeHandler {
   ...
   * {@link patagonia.http.cookie.Cookie} property.
   *
   * @param cookie {@link patagonia.http.cookie.Cookie} to be updated
   ...
   *
   * @param cookie {@link patagonia.http.cookie.Cookie} to validate
   ...
   *
   * @param cookie {@link patagonia.http.cookie.Cookie} to match
