...
import patagonia.http.nio.params.NIOReactorParams;
import patagonia.http.nio.reactor.IOEventDispatch;
import patagonia.http.nio.reactor.IOReactor;
import patagonia.http.nio.reactor.IOReactorException;
import patagonia.http.nio.reactor.IOReactorExceptionHandler;
 ...
 *  <li>{@link patagonia.http.nio.params.NIOReactorPNames#SELECT_INTERVAL}</li>
 *  <li>{@link patagonia.http.nio.params.NIOReactorPNames#GRACE_PERIOD}</li>
 *  <li>{@link patagonia.http.nio.params.NIOReactorPNames#INTEREST_OPS_QUEUEING}</li>
 * </ul>
 *
 * @since 4.0
 */
