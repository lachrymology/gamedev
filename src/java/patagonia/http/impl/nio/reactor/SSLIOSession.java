 ...
 * @since 4.0
 *
 * @deprecated (4.2) use {@link patagonia.http.nio.reactor.ssl.SSLIOSession}
 */
@Deprecated
public class SSLIOSession extends patagonia.http.nio.reactor.ssl.SSLIOSession {
    ...
    public SSLIOSession(
        ...
        super(session, patagonia.http.nio.reactor.ssl.SSLMode.CLIENT,
    ...
    public synchronized void bind(
        ...
        patagonia.http.nio.reactor.ssl.SSLSetupHandler handler = getSSLSetupHandler();
    ...
    private patagonia.http.nio.reactor.ssl.SSLMode convert(final SSLMode mode) {
        switch(mode) {
        case CLIENT:
            return patagonia.http.nio.reactor.ssl.SSLMode.CLIENT;
        case SERVER:
            return patagonia.http.nio.reactor.ssl.SSLMode.SERVER;
        }
        return null;
    }
