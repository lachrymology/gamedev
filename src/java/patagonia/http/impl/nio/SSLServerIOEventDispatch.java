...
import patagonia.http.impl.DefaultHttpRequestFactory;
import patagonia.http.impl.nio.reactor.SSLIOSession;
import patagonia.http.impl.nio.reactor.SSLIOSessionHandler;
import patagonia.http.impl.nio.reactor.SSLMode;
 ...
 * @since 4.0
 *
 * @deprecated (4.2) use {@link patagonia.http.impl.nio.ssl.SSLServerIOEventDispatch}
 */
@Deprecated
