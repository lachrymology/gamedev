...
import patagonia.http.HttpVersion;
import patagonia.http.annotation.ThreadSafe;
import patagonia.http.client.HttpClient;
import patagonia.http.client.protocol.RequestAddCookies;
import patagonia.http.client.protocol.RequestAuthCache;
import patagonia.http.client.protocol.RequestClientConnControl;
import patagonia.http.client.protocol.RequestDefaultHeaders;
import patagonia.http.client.protocol.RequestProxyAuthentication;
import patagonia.http.client.protocol.RequestTargetAuthentication;
import patagonia.http.client.protocol.ResponseProcessCookies;
...
import patagonia.http.protocol.BasicHttpProcessor;
...
import patagonia.http.util.VersionInfo;
