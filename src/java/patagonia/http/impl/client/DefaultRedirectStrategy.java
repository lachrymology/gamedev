...
import patagonia.http.client.CircularRedirectException;
import patagonia.http.client.RedirectStrategy;
import patagonia.http.client.methods.HttpDelete;
import patagonia.http.client.methods.HttpEntityEnclosingRequestBase;
import patagonia.http.client.methods.HttpGet;
import patagonia.http.client.methods.HttpHead;
import patagonia.http.client.methods.HttpOptions;
import patagonia.http.client.methods.HttpPatch;
import patagonia.http.client.methods.HttpPost;
import patagonia.http.client.methods.HttpPut;
import patagonia.http.client.methods.HttpTrace;
