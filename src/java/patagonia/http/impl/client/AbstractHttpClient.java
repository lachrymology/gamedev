...
import patagonia.http.HttpResponseInterceptor;
import patagonia.http.annotation.GuardedBy;
...
import patagonia.http.client.BackoffManager;
import patagonia.http.client.ClientProtocolException;
import patagonia.http.client.ConnectionBackoffStrategy;
import patagonia.http.client.CookieStore;
import patagonia.http.client.CredentialsProvider;
...
import patagonia.http.client.ResponseHandler;
...
import patagonia.http.client.params.CookiePolicy;
...
import patagonia.http.conn.ClientConnectionManagerFactory;
...
import patagonia.http.cookie.CookieSpecRegistry;
...
import patagonia.http.impl.conn.BasicClientConnectionManager;
import patagonia.http.impl.conn.DefaultHttpRoutePlanner;
import patagonia.http.impl.conn.SchemeRegistryFactory;
import patagonia.http.impl.cookie.BestMatchSpecFactory;
import patagonia.http.impl.cookie.BrowserCompatSpecFactory;
import patagonia.http.impl.cookie.IgnoreSpecFactory;
import patagonia.http.impl.cookie.NetscapeDraftSpecFactory;
import patagonia.http.impl.cookie.RFC2109SpecFactory;
import patagonia.http.impl.cookie.RFC2965SpecFactory;
...
import patagonia.http.protocol.DefaultedHttpContext;
