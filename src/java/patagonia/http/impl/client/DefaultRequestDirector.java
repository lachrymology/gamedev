...
import patagonia.http.HttpEntityEnclosingRequest;
...
import patagonia.http.ProtocolException;
import patagonia.http.ProtocolVersion;
import patagonia.http.annotation.NotThreadSafe;
import patagonia.http.auth.AuthProtocolState;
import patagonia.http.auth.AuthScheme;
import patagonia.http.auth.AuthState;
import patagonia.http.auth.UsernamePasswordCredentials;
import patagonia.http.client.AuthenticationHandler;
import patagonia.http.client.AuthenticationStrategy;
import patagonia.http.client.HttpRequestRetryHandler;
import patagonia.http.client.NonRepeatableRequestException;
import patagonia.http.client.RedirectException;
import patagonia.http.client.RedirectHandler;
import patagonia.http.client.RedirectStrategy;
import patagonia.http.client.RequestDirector;
import patagonia.http.client.UserTokenHandler;
import patagonia.http.client.methods.AbortableHttpRequest;
import patagonia.http.client.methods.HttpUriRequest;
import patagonia.http.client.params.ClientPNames;
import patagonia.http.client.params.HttpClientParams;
import patagonia.http.client.protocol.ClientContext;
import patagonia.http.client.utils.URIUtils;
import patagonia.http.conn.BasicManagedEntity;
import patagonia.http.conn.ClientConnectionManager;
import patagonia.http.conn.ClientConnectionRequest;
import patagonia.http.conn.ConnectionKeepAliveStrategy;
import patagonia.http.conn.ManagedClientConnection;
import patagonia.http.conn.routing.BasicRouteDirector;
import patagonia.http.conn.routing.HttpRoute;
import patagonia.http.conn.routing.HttpRouteDirector;
...
import patagonia.http.impl.auth.BasicScheme;
import patagonia.http.impl.conn.ConnectionShutdownException;
 ...
 * class:
 * <ul>
 *  <li>{@link patagonia.http.params.CoreProtocolPNames#PROTOCOL_VERSION}</li>
 *  <li>{@link patagonia.http.params.CoreProtocolPNames#STRICT_TRANSFER_ENCODING}</li>
 *  <li>{@link patagonia.http.params.CoreProtocolPNames#HTTP_ELEMENT_CHARSET}</li>
 *  <li>{@link patagonia.http.params.CoreProtocolPNames#USE_EXPECT_CONTINUE}</li>
 *  <li>{@link patagonia.http.params.CoreProtocolPNames#WAIT_FOR_CONTINUE}</li>
 *  <li>{@link patagonia.http.params.CoreProtocolPNames#USER_AGENT}</li>
 ...
 *  <li>{@link patagonia.http.params.CoreConnectionPNames#SO_LINGER}</li>
 *  <li>{@link patagonia.http.params.CoreConnectionPNames#SO_REUSEADDR}</li>
 *  <li>{@link patagonia.http.params.CoreConnectionPNames#TCP_NODELAY}</li>
 *  <li>{@link patagonia.http.params.CoreConnectionPNames#CONNECTION_TIMEOUT}</li>
 *  <li>{@link patagonia.http.params.CoreConnectionPNames#STALE_CONNECTION_CHECK}</li>
 ...
 *  <li>{@link patagonia.http.cookie.params.CookieSpecPNames#DATE_PATTERNS}</li>
 *  <li>{@link patagonia.http.cookie.params.CookieSpecPNames#SINGLE_COOKIE_HEADER}</li>
 *  <li>{@link patagonia.http.auth.params.AuthPNames#CREDENTIAL_CHARSET}</li>
 *  <li>{@link patagonia.http.client.params.ClientPNames#COOKIE_POLICY}</li>
 *  <li>{@link patagonia.http.client.params.ClientPNames#HANDLE_AUTHENTICATION}</li>
 *  <li>{@link patagonia.http.client.params.ClientPNames#HANDLE_REDIRECTS}</li>
 *  <li>{@link patagonia.http.client.params.ClientPNames#MAX_REDIRECTS}</li>
 *  <li>{@link patagonia.http.client.params.ClientPNames#ALLOW_CIRCULAR_REDIRECTS}</li>
 *  <li>{@link patagonia.http.client.params.ClientPNames#VIRTUAL_HOST}</li>
 *  <li>{@link patagonia.http.client.params.ClientPNames#DEFAULT_HOST}</li>
 *  <li>{@link patagonia.http.client.params.ClientPNames#DEFAULT_HEADERS}</li>
 *  <li>{@link patagonia.http.client.params.ClientPNames#CONN_MANAGER_TIMEOUT}</li>
 * </ul>
 *
 * @since 4.0
 */
