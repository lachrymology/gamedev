...
import patagonia.http.ReasonPhraseCatalog;
import patagonia.http.StatusLine;
import patagonia.http.annotation.Immutable;
import patagonia.http.impl.EnglishReasonPhraseCatalog;
import patagonia.http.message.BasicHttpResponse;
import patagonia.http.message.BasicStatusLine;
