...
import patagonia.http.conn.params.ConnManagerParams;
import patagonia.http.conn.params.ConnPerRoute;
 ...
 * @since 4.0
 *
 * @deprecated (4.2)  use {@link patagonia.http.pool.AbstractConnPool}
 */
@Deprecated 
