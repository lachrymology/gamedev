...
import patagonia.http.conn.ClientConnectionOperator;
import patagonia.http.conn.ConnectTimeoutException;
import patagonia.http.conn.DnsResolver;
import patagonia.http.conn.HttpHostConnectException;
import patagonia.http.conn.HttpInetSocketAddress;
import patagonia.http.conn.OperatedClientConnection;
import patagonia.http.conn.scheme.Scheme;
import patagonia.http.conn.scheme.SchemeLayeredSocketFactory;
import patagonia.http.conn.scheme.SchemeRegistry;
import patagonia.http.conn.scheme.SchemeSocketFactory;
 ...
 * {@link patagonia.http.params.CoreConnectionPNames#CONNECTION_TIMEOUT} value will be used
