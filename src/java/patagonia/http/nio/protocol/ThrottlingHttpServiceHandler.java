...
import patagonia.http.HttpStatus;
import patagonia.http.HttpVersion;
import patagonia.http.MethodNotSupportedException;
import patagonia.http.ProtocolException;
import patagonia.http.ProtocolVersion;
import patagonia.http.UnsupportedHttpVersionException;
import patagonia.http.annotation.ThreadSafe;
import patagonia.http.entity.ByteArrayEntity;
import patagonia.http.nio.ContentDecoder;
import patagonia.http.nio.ContentEncoder;
import patagonia.http.nio.IOControl;
import patagonia.http.nio.NHttpConnection;
import patagonia.http.nio.NHttpServerConnection;
import patagonia.http.nio.NHttpServiceHandler;
import patagonia.http.nio.entity.ContentBufferEntity;
import patagonia.http.nio.entity.ContentOutputStream;
import patagonia.http.nio.params.NIOReactorPNames;
import patagonia.http.nio.util.ByteBufferAllocator;
import patagonia.http.nio.util.ContentInputBuffer;
import patagonia.http.nio.util.ContentOutputBuffer;
import patagonia.http.nio.util.DirectByteBufferAllocator;
import patagonia.http.nio.util.SharedInputBuffer;
import patagonia.http.nio.util.SharedOutputBuffer;
import patagonia.http.params.DefaultedHttpParams;
...
import patagonia.http.protocol.HttpExpectationVerifier;
import patagonia.http.protocol.HttpProcessor;
import patagonia.http.protocol.HttpRequestHandler;
import patagonia.http.protocol.HttpRequestHandlerResolver;
 ...
 * class:
 * <ul>
 *  <li>{@link patagonia.http.nio.params.NIOReactorPNames#CONTENT_BUFFER_SIZE}</li>
